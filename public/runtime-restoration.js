...
function markLiveNav(){LIVE_IDS.forEach(id=>{const b=document.querySelector('#nav [data-shell-id="'+id+'"]');if(!b)return;const s=b.querySelector('.shell-state');if(s&&s.textContent!=='LIVE'){s.classList.add('live');s.textContent='LIVE';}})}
