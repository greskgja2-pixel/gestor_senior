 ...
 * A API get_time_slot_id não recebe start_time/end_time; o recorte por período
 * deve ser feito localmente depois que a Shopee devolver os slots disponíveis.
 */
export async function getFlashSaleTimeSlots({ shopId, accessToken }) {
