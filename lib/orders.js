...
async function syncFromShopee(shop) {
  ...
  let cursor = "";
    const allOrderSns = [];
    const MAX_PAGES = 60; // ate 3000 pedidos - trava um loop infinito por resposta inesperada da Shopee
...
/** Devolve os pedidos da loja (ultimos 15 dias): do cache por padrao, ou buscando na Shopee se `forceRefresh` ou cache vazio. */
