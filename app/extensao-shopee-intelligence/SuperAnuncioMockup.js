...
function Sidebar({connected}){return <aside className={styles.sidebar}><div className={styles.brand}><span>GS</span><div><b>Gestor Sênior</b><small>Shopee Intelligence</small></div></div><nav><Link href="/">⌂ <span>Dashboard</span></Link><Link href="/produtos">▱ <span>Produtos</span></Link><Link href="/super-analise">▤ <span>Super Análise</span></Link><Link className={styles.active} href="/extensao-shopee-intelligence?section=super-anuncio">▣ <span>Super Anúncio</span></Link><Link href="/extensao-shopee-intelligence?section=concorrentes">⌘ <span>Concorrentes</span></Link><Link href="/extensao-shopee-intelligence?section=shopee-ads">◎ <span>Shopee Ads</span></Link><Link href="/protecao-roas">◈ <span>Proteção ROAS</span></Link><Link href="/extensao-shopee-intelligence?section=reanalises">↻ <span>Reanálises</span></Link><Link href="/extensao-shopee-intelligence?section=prioridades">☆ <span>Prioridades</span></Link><Link href="/extensao-shopee-intelligence?section=relatorios">▤ <span>Relatórios</span></Link></nav><div className={styles.motor}><div><i className={connected?styles.online:styles.offline}/><b>Motor Senior</b></div><strong>{connected?'Conectado e pronto':'Desconectado'}</strong><small>Coleta e executa tarefas na Shopee em segundo plano.</small></div></aside>}
