...
export async function POST(request){
  ...
  let visualImages=0;
  visualImages+=await appendImageGroup(parts,'IMAGENS DO ANÚNCIO DO USUÁRIO — compare estas imagens com os concorrentes.',safeArray(p.imageUrls||p.image?.image_url_list));
