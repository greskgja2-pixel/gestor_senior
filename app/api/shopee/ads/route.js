...
export async function GET(request){
  ...
  // A Shopee limita Ads; mantemos a leitura principal em exatamente 5 chamadas.
  // O resumo visível usa somente campanhas de produto para bater com "Todos os Anúncios de Produtos".
