...
import { OAUTH_COOKIE, OAUTH_SECONDS, cookieOptions, newOauthState } from '../../../../lib/shop-session';
...
export async function GET(request){
  try{
    ...
    response.cookies.set(OAUTH_COOKIE,state,cookieOptions(OAUTH_SECONDS,'/api/shopee/callback'));
    return response;
  }catch(error){
