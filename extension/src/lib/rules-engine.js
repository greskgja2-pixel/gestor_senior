...
const missingCost=v=>v===null||v===undefined||v===''||!Number.isFinite(Number(v))||Number(v)<0;
...
export function evaluateCampaign({campaign, product, policy={}, lastChangeAt=null}){
  ...
  if(missingCost(product?.productCost))reasons.push('Custo do produto não informado; automação financeira bloqueada');
